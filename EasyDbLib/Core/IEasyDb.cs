...
namespace EasyDbLib
{
    public interface IEasyDb
    {
        ...
        Task<List<TModel>> SelectAllAsync<TModel>(ISelectionAllCommandFactory<TModel> selectionAllCommandFactory, IModelFactory<TModel> modelFactory) where TModel : class, new();
        ...
        Task<TModel> SelectOneAsync<TModel>(ISelectionOneCommandFactory<TModel> selectionOneCommandFactory, TModel model, IModelFactory<TModel> modelFactory) where TModel : class, new();
