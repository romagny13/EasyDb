...
namespace EasyDbLib
{
    public interface IEasyDb
    {
        ...
        Task<int> DeleteAsync<TModel>(TModel model, Check condition, DbTransaction transaction = null) where TModel : class, new();
        ...
        Task<List<TModel>> SelectAllAsync<TModel, TCriteria>(ISelectionAllCommandFactory<TModel, TCriteria> selectionAllCommandFactory, TCriteria criteria) where TModel : class, new();
        ...
        Task<List<TModel>> SelectAllAsync<TModel>(ISelectionAllCommandFactory<TModel, NullCriteria> selectionAllCommandFactory) where TModel : class, new();
        ...
        Task<TModel> SelectOneAsync<TModel, TCriteria>(ISelectionOneCommandFactory<TCriteria> selectionOneCommandFactory, TCriteria criteria) where TModel : class, new();
