...
namespace EasyDbLib
{
    ...
    public class QueryService : IQueryService
    {
        ...
        public virtual string GetSelectFromOrderBy(Table mapping, string[] statements, int? limit, ConditionAndParameterContainer condition, string[] sorts)
        {
            return this.GetSelect(statements, limit, mapping)
