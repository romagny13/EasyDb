...
namespace EasyDbLib
{
    public class Condition
    {
        ...
        public static ConditionNull IsNotNull(string column)
        {
            return new ConditionNull(column, false);
        }

        public static ConditionNull IsNull(string column)
        {
            return new ConditionNull(column, true);
        }
    }
}