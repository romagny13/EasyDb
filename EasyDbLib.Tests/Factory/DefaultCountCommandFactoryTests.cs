...
namespace EasyDbLib.Tests
{
    ...
    {
        public DefaultCountCommandFactory GetService()
        {
            return new DefaultCountCommandFactory();
        }
        ...
        public void GetQuery()
        {
            ...
            Assert.AreEqual("select count(*) from [User] where [Id]=@id", result);
        }
        ...
        public void GetQuery_WithBetween()
        {
            ...
            Assert.AreEqual("select count(*) from [User] where [Id] between 10 and 20", result);
        }
        ...
        public void GetQuery_WithLike()
        {
            ...
            Assert.AreEqual("select count(*) from [User] where [Id] like '%abc'", result);
        }
        ...
        public void GetQuery_WithIsNull()
        {
            ...
            Assert.AreEqual("select count(*) from [User] where [Id] is null", result);
        }
        ...
        public void GetQuery_WithIsNotNull()
        {
            ...
            Assert.AreEqual("select count(*) from [User] where [Id] is not null", result);
        }
        ...
        public void GetQuery_WithMultipleCondition()
        {
            ...
            Assert.AreEqual("select count(*) from [User] where [Id]=@id and [RoleId]=@roleid", result);
        }
        ...
        public void GetQuery_WithMapping()
        {
            ...
            Assert.AreEqual("select count(*) from [users] where [Id]=@id", result);
        }
        ...
        public void GetCommand()
        {
            ...
            Assert.AreEqual("select count(*) from [User] where [Id]=@id", result.CommandText);
        ...
        public void GetCommand_WithMultipleParameters()
        {
            ...
            Assert.AreEqual("select count(*) from [User] where [Id]=@id and [RoleId]=@roleid", result.CommandText);
            Assert.AreEqual(CommandType.Text, result.CommandType);
