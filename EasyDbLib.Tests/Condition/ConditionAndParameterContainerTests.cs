...
{
    [TestClass]
    public class ConditionAndParameterContainerTests
    {
        [TestMethod]
        public void TestCreateMain_WithOp()
        {
            ...
            Assert.AreEqual("id", container.Main.ColumnName);
        ...
        public void TestCreateMain_WithLike()
        {
            ...
            Assert.AreEqual("name", container.Main.ColumnName);
        ...
        public void TestCreateMain_WithBetween()
        {
            ...
            Assert.AreEqual("range", container.Main.ColumnName);
            Assert.AreEqual(false, container.Main.IsConditionOp);
        ...
        public void TestCreateMain_WithIsNull()
        {
            ...
            Assert.AreEqual("user_id", container.Main.ColumnName);
            Assert.AreEqual(false, container.Main.IsConditionOp);
        ...
        public void TestCreateSub_Multiples()
        {
            ...
            Assert.AreEqual("id", result2.ColumnName);
