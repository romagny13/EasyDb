...
namespace EasyDbLibTest
{
    ...
    //    {
    //        var db = new EasyDb();
    //        db.SetQueryService("System.Data.OleDb", new OleDbQueryService());
    //        db.SetConnectionStringSettings(this.connectionString, this.providerName);
    ...
    //        db.SetQueryService("System.Data.OleDb", new QueryService());
    ...
    //public class OleDbQueryService : QueryService
    //{
    //    public OleDbQueryService()
    //        : base("`", "`")
    //    { }
    ...
    //    {
    //       return "insert into " + this.FormatTableAndColumn(table) + " (" + this.GetColumns(columns, false) + ") values (" + this.GetParameters(columns) + ")";
    //    }
