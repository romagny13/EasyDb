...
{
    [TestClass]
    public class SelectRelationOneTest
    {
        ...
        public void TestInvalidPropertyName()
        {
            ...
            try
            {
                var main = db
                     ...
                     .HasOne<UserLikeTable>("U@ser", Mapping.GetTable("users"));
            }
            catch (Exception)
            {
                failed = true;
        ...
        public void TestValidPropertyName()
        {
            ...
            try
            {
                var main = db
                      .Select<PostLikeTable>(Mapping.GetTable("posts"))
                      .Where(Condition.Op("id", 1))
                      .HasOne<UserLikeTable>("User", Mapping.GetTable("users"));
            }
            catch (Exception)
            {
                failed = true;
        ...
        public void TestFetch_HasMultipleRelationOnes()
        {
            ...
            Mapping.AddTable("posts")
                .AddForeignKeyColumn("user_id", "user_id", "users", "id")
                .AddForeignKeyColumn("category_id", "category_id", "categories", "id");
            ...
            var result = db
                    ...
                    .Where(Condition.Op("id", 1))
                    .HasOne<UserLikeTable>("User", Mapping.GetTable("users"))
                    .HasOne<CategoryLikeTable>("Category", Mapping.GetTable("categories"));
